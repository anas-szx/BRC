...
def main(input_file_name="testcase.txt", output_file_name="output.txt"):
    ...
    for city in sorted_cities:
        ...
        min_temp = round_inf(data['min'])
        mean_temp = round_inf(data['sum'] / data['count'])
        max_temp = round_inf(data['max'])
        output_file.write(f"{city}={min_temp:.1f}/{mean_temp:.1f}/{max_temp:.1f}\n")
